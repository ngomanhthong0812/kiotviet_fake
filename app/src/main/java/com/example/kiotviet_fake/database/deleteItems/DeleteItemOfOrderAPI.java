...
public class DeleteItemOfOrderAPI {
    private static final String BASE_URL = "http://ngomanhthong-001-site1.htempurl.com/";

    public static DeleteItemOfOrderService createService(String username, String password) {
        ...
        return retrofit.create(DeleteItemOfOrderService.class);
    }
}
