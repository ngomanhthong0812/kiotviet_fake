...
public class OrderDeleteItemsApiClient {
    private static final String BASE_URL = "http://ngomanhthong-001-site1.htempurl.com/";

    public static OrderDeleteItemsService createService(String username, String password) {
        ...
        return retrofit.create(OrderDeleteItemsService.class);
    }
}
