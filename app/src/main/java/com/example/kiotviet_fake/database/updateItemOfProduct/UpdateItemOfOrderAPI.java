...
public class UpdateItemOfOrderAPI {
    private static final String BASE_URL = "http://ngomanhthong-001-site1.htempurl.com/";

    public static UpdateItemOfOrderService createService(String username, String password) {
        ...
        return retrofit.create(UpdateItemOfOrderService.class);
    }
}
